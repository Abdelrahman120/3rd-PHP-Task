    ...
    <div class="container">
        ...
        <form class="pb-5" action="saving.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php $eval = isset($old_data['name']) ? $old_data['name'] : "";
                                                                                                                                echo $eval; ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php $eval = isset($old_data['email']) ? $old_data['email'] : "";
                                                                                                                                    echo $eval; ?>">
                <span class="text-danger">
